    ...
    return (
        <div>
            ...
            <div className="experience">
                <ScrollReveal> 
                    <motion.img   initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} viewport={{ once: true }} className="timeline" src={timeline} ></motion.img>
                </ScrollReveal> 
            </div>
        </div>
