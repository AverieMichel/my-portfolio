...
function Projects() {
  ...
  const lorum = " freestar freestar Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vulputate, quam vel eleifend euismod, lacus ipsum vestibulum ex, et lacinia odio arcu et orci. Pellentesque pellentesque consequat tristique. Donec mattis vehicula lectus, et auctor urna suscipit ac. Aenean ex erat, viverra quis consectetur vitae, auctor ac lacus. Donec metus nibh, viverra in vestibulum in, bibendum sed metus. Ut ut ante nec leo tempus suscipit. Cras tortor arcu, egestas at rutrum non, sollicitudin sed tortor. Quisque dapibus magna eget lacus viverra, at facilisis elit pellentesque. Pellentesque luctus justo nec enim iaculis, eu semper ante aliquam. Praesent tempus diam sed semper sagittis. Sed vitae sodales lectus. Donec blandit tempus nisi non hendrerit. Vestibulum tempus at nisl vel imperdiet. Morbi risus velit, faucibus non luctus non, volutpat eu lorem. Morbi at sem leo." ;
    return (
        <div style={{color: 'whitesmoke'}}>
            ...
            <div className="projects-container">
                ...
                transition={{ 
                    ...
                    y: { duration: 0.8, ease: [0.68, -0.55, 0.27, 1.55], delay: 0.6 } // bounce easing
                }}
                ...
                <div className="projects">
                    ...
                    <h3>The Keeper APP:</h3>
                        <img src="/images/TheKeeperApp.exmaple.png" width='700px'></img>  
                        <ScrollReveal>
                    ...
                    <div className="project">
                    <h3>Movie Blog:</h3>
                        <video src="/images/movies.example.mov" width='700px' controls></video>
                        <ScrollReveal>
